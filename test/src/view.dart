...
/// App's very source code
export 'package:app_template/src/model.dart';

export 'package:app_template/src/view.dart';

export 'package:app_template/src/controller.dart';

/// Unit Tests
export 'tests/unit/wordpairs_model.dart';

export 'tests/unit/controller_test.dart';
